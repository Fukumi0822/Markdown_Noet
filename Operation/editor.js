...
class Editor{
  constructor(Selector){
    ...
    //ボタンのイベント登録
    let buttonElement = document.querySelectorAll("#Toolbar .left .groupbutton button");
  ...
  clickEventButton_TableCode(){
    let widget = document.querySelector("div.tableInWidget");
    let button = document.querySelector("div.tableInWidget button");
    let input  = document.querySelectorAll("div.tableInWidget input");
